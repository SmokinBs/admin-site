...
const SEO: React.FC<SEOProps> = ({ description, keywords, title }) => (
    <Head>
        <title>{title} | Smokin Bs BBQ</title>
        ...
        <link rel="apple-touch-icon" type="image/svg" href="/icons/icon.svg" />
...
SEO.defaultProps = {
    description: "Smokin Bs BBQ Admin dashboard site",
    keywords: ["admin-dashboard", "admin", "food", "bbq"],
};
